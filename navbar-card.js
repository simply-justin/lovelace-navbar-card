 ...
 */var at;null===(at=window.HTMLSlotElement)||void 0===at||at.prototype.assignedElements;var dt;!function(t){t.top="top",t.left="left",t.bottom="bottom",t.right="right"}(dt||(dt={}));window.customCards=window.customCards||[],window.customCards.push({type:"navbar-card",name:"Navbar card",preview:!0,description:"Card with a full-width bottom nav on mobile and a flexible nav on desktop that can be placed on any side of the screen."});let ht=class extends ot{constructor(){super(...arguments),this._onResize=()=>{this.screenWidth=window.innerWidth}}evaluateBadge(t){if(!t||!this.hass)return!1;try{return new Function("states",`return ${t}`)(this.hass.states)}catch(t){return console.warn(`NavbarCard: Error evaluating badge template: ${t}`),!1}}connectedCallback(){var t,e,i,s,o;super.connectedCallback(),this._location=window.location.pathname,window.addEventListener("resize",this._onResize),this.screenWidth=window.innerWidth,this._inEditMode=null!=(null===(t=this.parentElement)||void 0===t?void 0:t.closest("hui-card-edit-mode")),this._inPreviewMode=null!=(null===(o=null===(s=null===(i=null===(e=document.querySelector("body > home-assistant"))||void 0===e?void 0:e.shadowRoot)||void 0===i?void 0:i.querySelector("hui-dialog-edit-card"))||void 0===s?void 0:s.shadowRoot)||void 0===o?void 0:o.querySelector("ha-dialog > div.content > div.element-preview"))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._onResize)}setConfig(t){this._config=t}shouldUpdate(t){let e=!1;return t.forEach(((t,i)=>{var s;(["_config","screenWidth","_inEditMode","_inPreviewMode","_location"].includes(i)||"hass"==i&&(new Date).getTime()-(null!==(s=this._lastRender)&&void 0!==s?s:0)>1e3)&&(e=!0)})),e}render(){var t,e;if(!this._config)return j``;const{routes:i,desktop:s,mobile:o}=this._config,{position:n,show_labels:r,min_width:l}=null!=s?s:{},{show_labels:a}=null!=o?o:{};this._lastRender=(new Date).getTime();const d=(null!==(t=this.screenWidth)&&void 0!==t?t:0)>=(null!=l?l:768),h=null!==(e=((t,e)=>{if(Object.values(t).includes(e))return e})(dt,n))&&void 0!==e?e:dt.bottom,c=d?"desktop":"mobile",p=this._inEditMode||this._inPreviewMode?"edit-mode":"";return j`
      <ha-card
        ...
        ${null==i?void 0:i.map(((t,e)=>{var i,s,o;const n=this._location==t.url,l=this.evaluateBadge(null===(i=t.badge)||void 0===i?void 0:i.template);return j`
            <a
              ...
              ${d&&r||!d&&a?j`<div class="label ${n?"active":""}">
    ...
    `}};t([lt()],ht.prototype,"hass",void 0),t([lt()],ht.prototype,"_config",void 0),t([lt()],ht.prototype,"screenWidth",void 0),t([lt()],ht.prototype,"_inEditMode",void 0),t([lt()],ht.prototype,"_inPreviewMode",void 0),t([lt()],ht.prototype,"_lastRender",void 0),t([lt()],ht.prototype,"_location",void 0),ht=t([(t=>e=>"function"==typeof e?((t,e)=>(customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(e){customElements.define(t,e)}}})(t,e))("navbar-card")],ht),console.info("%c navbar-card %c 0.0.5 ","background-color: #555;      padding: 6px 4px;      color: #fff;      text-shadow: 0 1px 0 rgba(1, 1, 1, 0.3);       border-radius: 10px 0 0 10px;","background-color: #00abd1;       padding: 6px 4px;      color: #fff;      text-shadow: 0 1px 0 rgba(1, 1, 1, 0.3);       border-radius: 0 10px 10px 0;");export{ht as NavbarCard};
