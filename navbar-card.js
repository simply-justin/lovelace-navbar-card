 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var at;null===(at=window.HTMLSlotElement)||void 0===at||at.prototype.assignedElements;window.customCards=window.customCards||[],window.customCards.push({type:"navbar-card",name:"Navbar card",preview:!0,description:"Card that displays a bottom nav in mobile devices, and a side nav in desktop devices"});let ht=class extends nt{constructor(){super(),this._onResize=()=>{this.screenWidth=window.innerWidth},console.info("%c navbar-card %c 0.0.3 ","background-color: #555;      padding: 6px 4px;      color: #fff;      border-radius: 10px 0 0 10px;","background-color: #00abd1;       color: #fff;      padding: 6px 4px;      border-radius: 0 10px 10px 0;")}connectedCallback(){var t;super.connectedCallback(),window.addEventListener("resize",this._onResize),this.screenWidth=window.innerWidth,this.inEditMode=null!==(null===(t=this.parentElement)||void 0===t?void 0:t.closest("hui-card-edit-mode"))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("resize",this._onResize)}setConfig(t){this._config=t}render(){var t,e;if(!this._config)return j``;const i=(null!==(t=this.screenWidth)&&void 0!==t?t:0)>=(null!==(e=this._config.desktop_min_width)&&void 0!==e?e:768),{routes:s}=this._config;return j`
      <ha-card
